...
# the output will be printed to your bpx root path, e.g. ~/.bpxchain/beacon/profile/
# to analyze the profile, run:

#   python bpx/utils/profiler.py ~/.bpxchain/beacon/profile | less -r
...
#   python bpx/utils/profiler.py ~/.bpxchain/beacon/profile 10 20
